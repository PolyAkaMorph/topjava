...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_FILTERED, query = "SELECT m FROM Meal m WHERE m.user=?1 AND m.dateTime BETWEEN ?2 AND ?3 ORDER BY m.dateTime desc")
})
@Entity
@Table(name = "meals", uniqueConstraints = {@UniqueConstraint(columnNames = {"user_id","date_time"}, name = "meals_unique_user_datetime_idx")})
public class Meal extends AbstractBaseEntity {
    public static final String DELETE = "Meals.delete";
    public static final String BY_ID_AND_USER = "Meals.getByIdAndUser";
    public static final String ALL_SORTED = "Meals.getAllSorted";
    public static final String ALL_FILTERED = "Meals.getAllFiltered";
